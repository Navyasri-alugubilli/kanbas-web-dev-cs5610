    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                to summarize the topic of the section it precedes. For instance this paragraph is
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Place the milk a saucepan over medium-low heat.</li>
                    <li>Whisk in cocoa powder and sugar, and heat until warm.</li>
                    <li>Once the milk is warm, add chocolate , whisking until they melt into the milk.</li>
            ...
            <div id="wd-forms">
                ...
                <input id="wd-text-fields-username" type="text" placeholder="uaerame" /> <br />
                <label htmlFor="wd-text-fields-password">Password:</label>
                <input type="password" id="wd-text-fields-password" value="123@#$asd" />
                <br />
                <label htmlFor="wd-text-fields-first-name">First name:</label>
                <input type="text" id="wd-text-fields-first-name" title="Navya Sri" /> <br />
                <label htmlFor="wd-text-fields-last-name">Last name:</label>
                <input type="text" id="wd-text-fields-last-name" placeholder="Alugubilli"
                    value="Wonderland" title="The last name" />
                <h5>Text boxes</h5>
                <label>Biography:</label><br />
                <textarea id="wd-textarea" cols={100} rows={10}>Lorem ipsum dolor sit amet,
